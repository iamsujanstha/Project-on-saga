...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg  fixed-top navbar-light bg-light p-3">
        <div className="nav-container">
          <i
            className="fa-solid fa-blog"
            style={{ cursor: "pointer", fontSize: "35px", color: "#DBDCD0" }}
            onClick={() => {
              navigate("/");
            }}
          />
          ...
          <span>
            ...
            >
              ...
              <button
                onClick={handleClick}
                className={`btn btn-md btn-${authState ? "secondary" : "info"}`}
              >
                {authState ? t("logout") : t("login")}
              </button>
            </div>
          </span>
        </div>
